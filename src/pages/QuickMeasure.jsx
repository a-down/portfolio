  ...
  return (
    <>
      <div className="font-jost relative w-full ">
          ...
          <div className="grid grid-cols-8 grid-rows-2 gap-4 my-4">
            ...
            <div className="col-span-2 h-[280px] bg-green-600 shadow-sm rounded-3xl px-6 py-4 flex justify-center items-center">
              <div className='flex flex-col items-center justify-center'>
                <img src={walkingIcon} className="h-[200px] mr-4"/>
              </div>
            </div>
        ...
        {/* CONTACT SECTION */}
        <div className="mt-32 mb-16 px-4 md:px-16 lg:px-24 ">
        ...
        <footer className="w-full bg-green-600">
          <div className=" flex justify-between px-4 md:px-16 lg:px-24 py-8">
            <a href="/" className="transition-all hover:opacity-60 flex gap-2 items-center text-xl">
              <FiArrowLeft />Return to alecdowning.com</a>
            <a href="https://apps.apple.com/us/app/quick-measure-gps/id6473677147" target="_blank" className="bg-black/90 backdrop-blur-xl hover:bg-black/75 transition-all rounded-2xl flex justify-between items-center gap-4 text-xl text-white font-medium px-4 py-2.5">
              <p className="">View on the Apple App Store</p>
              <SiAppstore className="w-8 h-8 "/>
            </a>
          </div>
