      ...
      <div className=" flex flex-col justify-center gap-16 w-100 bg-accent p-24 items-center">
        ...
        <div className='flex justify-between w-full max-w-[974px]'>
          <div className="font-serif max-w-[800px]">
            ...
            <p className='p-4'>I specialize in React and JavaScript while using Tailwind, Bootstrap, Bulma, Chakra, and GitHub. I also have experience with Node.js, Express.js, MySQL, Sequelize, MongoDB, Mongoose, and Handlebars.</p>
          </div>
