...
export default function About() {
  const myTechStack = ['React', 'JavaScript', 'Tailwind', 'Radix UI', 'HTML', 'CSS', 'Bootstrap', 'jQuery', 'GitHub', 'Node.js', 'Express.js', 'MongoDB']
        ...
        <div className=" flex flex-col justify-center gap-4 md:gap-16 w-100 bg-accent p-4 pb-8 md:p-10 lg:p-24 items-center">
          ...
          <div className='flex flex-col md:flex-row justify-between w-full max-w-[974px]'>
            <div className="font-serif max-w-[800px]">
              ...
              <p className='p-4 pt-0 text-justify'>focused on React, NextJS, JavaScript, and Tailwind. I am also comfortable using jQuery, various CSS Frameworks (Bootstrap, Material UI, Radix UI, Chakra, Bulma), and GitHub. I have full-stack experience with NodeJS, ExpressJS, MongoDB, Mongoose, MySQL, Sequelize, JWT, and Clerk.</p>
