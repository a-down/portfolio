      ...
      <header className=' w-full h-[100px] max-w-[1400px] px-24 pl-[84px]'>
        ...
        <div className='h-full items-center flex justify-between w-full opacity-100'>
          ...
          <nav className=' text-base flex items-center gap-6 text-brand-400 font-semibold'>
            ...
            <a href='/#about' className=' hover:scale-105 transition-all active:text-brand-800'>About</a>
            <a href='/projects' className={` hover:scale-105 transition-all text-brand-${location === 'projects' ? '800' : '400'}`}>
              Projects
            </a>
            <a href='/#contact' className=' hover:scale-105 transition-all active:text-brand-800'>Contact</a>
