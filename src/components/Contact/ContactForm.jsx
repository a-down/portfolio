...
export default function ContactForm() {
  ...
  return (
    <form className='w-full md:w-2/3 bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 rounded-md text-navy p-4 flex flex-col gap-4 text-sm font-serif' style={{filter: `drop-shadow(0px 2px 3px #999999`}}>
      <FormControl>
        <label >Name:</label>
